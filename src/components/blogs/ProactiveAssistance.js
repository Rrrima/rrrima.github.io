  ...
  return (
    <div className="blog-with-toc">
      ...
      <div className="blog-content-wrapper">
        <Emphasis>why i want a tiny fairy living in my computer.</Emphasis>
        ...
        <Section id="tiny-thing">
          ...
          <BlockImage
            ...
            alt="tiny fairy bubble"
            caption="co-created with GPT-5"
            width="30%"
          />
        ...
        <Section id="end-notes" marginTop={false}>
          ...
          <Paragraph>
            ...
            you, and more like a tiny, well-informed fairy that
            <List>
